...
public class BlurTransformation extends BitmapTransformation {
    ...
    private static final String ID = "com.gaoxianglong.maque.utils.BlurTransformation";
    ...
    public BlurTransformation(Context context, BitmapPool bitmapPool, int radius, int sampling) {
